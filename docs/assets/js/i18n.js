...
(function () {
  ...
  const T = {
    ...
    hero_badges: { en: '<i class="bi bi-shield-lock me-1"></i>100% local inference <span class="mx-1">/</span> <i class="bi bi-laptop me-1"></i>Desktop app + CLI <span class="mx-1">/</span> <i class="bi bi-windows me-1"></i>Windows <i class="bi bi-apple ms-2 me-1"></i>macOS <i class="bi bi-tux ms-2 me-1"></i>Linux', ja: '<i class="bi bi-shield-lock me-1"></i>100% ローカル推論 <span class="mx-1">/</span> <i class="bi bi-laptop me-1"></i>デスクトップアプリ＋CLI <span class="mx-1">/</span> <i class="bi bi-windows me-1"></i>Windows <i class="bi bi-apple ms-2 me-1"></i>macOS <i class="bi bi-tux ms-2 me-1"></i>Linux' },
