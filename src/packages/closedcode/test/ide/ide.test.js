...
describe("ide", () => {
  ...
  test("should detect Visual Studio Code Insiders", () => {
    process.env["TERM_PROGRAM"] = "vscode";
    process.env["GIT_ASKPASS"] = "/Applications/Visual Studio Code - Insiders.app/Contents/Resources/app/extensions/git/dist/askpass.sh";
  ...
  test("should recognize vscode-insiders CLOSEDCODE_CALLER", () => {
    process.env["CLOSEDCODE_CALLER"] = "vscode-insiders";
    expect(Ide.alreadyInstalled()).toBe(true);
  });
  test("should recognize vscode CLOSEDCODE_CALLER", () => {
    process.env["CLOSEDCODE_CALLER"] = "vscode";
    expect(Ide.alreadyInstalled()).toBe(true);
  });
  test("should return false for unknown CLOSEDCODE_CALLER", () => {
    process.env["CLOSEDCODE_CALLER"] = "unknown";
