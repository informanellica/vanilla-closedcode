...
describe("ConfigMarkdown: frontmatter parsing", async () => {
  const parsed = await ConfigMarkdown.parse(__dirname + "/fixtures/frontmatter.md");
...
describe("ConfigMarkdown: frontmatter parsing w/ empty frontmatter", async () => {
  const result = await ConfigMarkdown.parse(__dirname + "/fixtures/empty-frontmatter.md");
  test("should parse without throwing", () => {
...
describe("ConfigMarkdown: frontmatter parsing w/ no frontmatter", async () => {
  const result = await ConfigMarkdown.parse(__dirname + "/fixtures/no-frontmatter.md");
  test("should parse without throwing", () => {
    expect(result).toBeDefined();
    expect(result.data).toEqual({});
    expect(result.content.trim()).toBe("Content");
...
describe("ConfigMarkdown: frontmatter parsing w/ Markdown header", async () => {
  const result = await ConfigMarkdown.parse(__dirname + "/fixtures/markdown-header.md");
...
describe("ConfigMarkdown: frontmatter has weird model id", async () => {
  const result = await ConfigMarkdown.parse(__dirname + "/fixtures/weird-model-id.md");
  test("should parse and match", () => {
    expect(result).toBeDefined();
