...
export const WebCommand = effectCmd({
  ...
  describe: "start closedcode server and open web interface",
  ...
  handler: Effect.fn("Cli.web")(function* (args) {
    if (!Flag.CLOSEDCODE_SERVER_PASSWORD) {
      UI.println(UI.Style.TEXT_WARNING_BOLD + "!  CLOSEDCODE_SERVER_PASSWORD is not set; server is unsecured.");
    }
