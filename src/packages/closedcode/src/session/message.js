...
export const MessagePart = Schema.Union([TextPart, ReasoningPart, ToolInvocationPart, SourceUrlPart, FilePart, StepStartPart]).annotate({
...
export const Info = Schema.Struct({
  ...
  metadata: Schema.Struct({
    ...
    sessionID: SessionID,
    tool: Schema.Record(Schema.String, Schema.StructWithRest(Schema.Struct({
      title: Schema.String,
    ...
    assistant: Schema.optional(Schema.Struct({
