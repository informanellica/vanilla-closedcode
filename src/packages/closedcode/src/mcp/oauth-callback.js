...
import { OAUTH_CALLBACK_PORT, OAUTH_CALLBACK_PATH, parseRedirectUri } from "./oauth-provider.js";
...
<html>
<head>
  <title>ClosedCode - Authorization Successful</title>
  <style>
...
<body>
  <div class="container">
    ...
    <p>You can close this window and return to ClosedCode.</p>
  </div>
...
<html>
<head>
  <title>ClosedCode - Authorization Failed</title>
  <style>
    body { font-family: system-ui, -apple-system, sans-serif; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; background: #1a1a2e; color: #eee; }
    .container { text-align: center; padding: 2rem; }
...
export async function ensureRunning(redirectUri) {
  ...
  await new Promise((resolve, reject) => {
    server.listen(currentPort, () => {
      log.info("oauth callback server started", {
        port: currentPort,
        path: currentPath
      });
      resolve();
...
export * as McpOAuthCallback from "./oauth-callback.js";