...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the ClosedCode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the ClosedCode system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global ClosedCode configuration settings and preferences.
   */
  get(options) {
    return (options?.client ?? this.client).get({
      url: "/global/config",
   ...
   *
   * Update global ClosedCode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the ClosedCode server.
   */
  health(options) {
    return (options?.client ?? this.client).get({
      url: "/global/health",
   ...
   * Get global events
   *
   * Subscribe to global events from the ClosedCode system using server-sent events.
   */
  event(options) {
   ...
   * Dispose instance
   *
   * Clean up and dispose all ClosedCode instances, releasing all resources.
   */
  dispose(options) {
    return (options?.client ?? this.client).post({
      url: "/global/dispose",
   ...
   * Upgrade closedcode
   *
   * Upgrade closedcode to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current ClosedCode configuration settings and preferences.
   */
   ...
   *
   * Update ClosedCode configuration settings and preferences.
   */
  update(parameters, options) {
    const params = buildClientParams([parameters], [{
      args: [{
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local ClosedCode state.
   */
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all ClosedCode sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.
   */
...
export class Workspace extends HeyApiClient {
  ...
  get adapter() {
    return this._adapter ??= new Adapter({
      client: this.client
    });
  }
}
export class Experimental extends HeyApiClient {
  get console() {
    return this._console ??= new Console({
      client: this.client
    });
  }
  get session() {
  ...
  get workspace() {
    return this._workspace ??= new Workspace({
      client: this.client
    });
  }
}
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current ClosedCode instance, releasing all resources.
   */
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the ClosedCode instance.
   */
  get(parameters, options) {
    const params = buildClientParams([parameters], [{
      args: [{
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the ClosedCode system.
   */
  list(parameters, options) {
    const params = buildClientParams([parameters], [{
      args: [{
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with ClosedCode.
   */
  list(parameters, options) {
    const params = buildClientParams([parameters], [{
      args: [{
   ...
   * Get current project
   *
   * Retrieve the currently active project that ClosedCode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by ClosedCode.
   */
  list(parameters, options) {
    const params = buildClientParams([parameters], [{
      args: [{
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all ClosedCode sessions, sorted by most recently updated.
   */
  list(parameters, options) {
    const params = buildClientParams([parameters], [{
      args: [{
   ...
   * Create session
   *
   * Create a new ClosedCode session for interacting with AI assistants and managing conversations.
   */
  create(parameters, options) {
    const params = buildClientParams([parameters], [{
      args: [{
   ...
   * Get session
   *
   * Retrieve detailed information about a specific ClosedCode session.
   */
  get(parameters, options) {
    const params = buildClientParams([parameters], [{
      args: [{
...
export class V2 extends HeyApiClient {
  get session() {
    return this._session ??= new Session3({
      client: this.client
    });
  }
}
...
export class OpencodeClient extends HeyApiClient {
  ...
  get app() {
    return this._app ??= new App({
      client: this.client
    });
  }
  get global() {
    return this._global ??= new Global({
      client: this.client
    });
  }
  get event() {
  ...
  get config() {
    return this._config ??= new Config2({
      client: this.client
    });
  }
  get experimental() {
    return this._experimental ??= new Experimental({
      client: this.client
    });
  }
  get tool() {
    return this._tool ??= new Tool({
      client: this.client
    });
  }
  get worktree() {
    return this._worktree ??= new Worktree({
      client: this.client
    });
  }
  get find() {
    return this._find ??= new Find({
      client: this.client
    });
  }
  get file() {
    return this._file ??= new File({
      client: this.client
    });
  }
  get instance() {
    return this._instance ??= new Instance({
      client: this.client
    });
  }
  get path() {
  ...
  get command() {
    return this._command ??= new Command({
      client: this.client
    });
  }
  get lsp() {
    return this._lsp ??= new Lsp({
      client: this.client
    });
  }
  get formatter() {
  ...
  get pty() {
    return this._pty ??= new Pty({
      client: this.client
    });
  }
  get question() {
    return this._question ??= new Question({
      client: this.client
    });
  }
  get permission() {
    return this._permission ??= new Permission({
      client: this.client
    });
  }
  get provider() {
  ...
  get session() {
    return this._session ??= new Session2({
      client: this.client
    });
  }
  get part() {
    return this._part ??= new Part({
      client: this.client
    });
  }
  get sync() {
    return this._sync ??= new Sync({
      client: this.client
    });
  }
  get v2() {
    return this._v2 ??= new V2({
      client: this.client
    });
  }
  get tui() {
    return this._tui ??= new Tui({
      client: this.client
    });
  }
}