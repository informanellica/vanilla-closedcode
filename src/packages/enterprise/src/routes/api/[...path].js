...
const app = new Hono();
app.basePath("/api").use(cors()).get("/doc", openAPIRouteHandler(app, {
  documentation: {
    info: {
...
}).post("/share/:shareID/sync", describeRoute({
  ...
  return c.json({});
}).get("/share/:shareID/data", describeRoute({
...
}).delete("/share/:shareID", describeRoute({
