/** @file Brazilian Portuguese (br) translation strings for the desktop Electron shell (menu, dialogs, updater, CLI installer). */

/**
 * Brazilian Portuguese translation dictionary keyed by dotted message id; values
 * may contain `{{var}}` placeholders that are interpolated at render time.
 * @type {Object}
 */
export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do ClosedCode",
  ...
  "desktop.updater.downloaded.prompt": "A versão {{version}} do ClosedCode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada em {{path}}\n\nReinicie seu terminal para usar o comando 'closedcode'.",
