/** @file Spanish (es) translation strings for the desktop Electron shell (menu, dialogs, updater, CLI installer). */

/**
 * Spanish translation dictionary keyed by dotted message id; values may contain
...
export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de ClosedCode",
  ...
  "desktop.updater.downloaded.prompt": "Se ha descargado la versión {{version}} de ClosedCode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada en {{path}}\n\nReinicia tu terminal para usar el comando 'closedcode'.",
