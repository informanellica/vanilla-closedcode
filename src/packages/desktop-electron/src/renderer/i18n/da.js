/** @file Danish (da) translation strings for the desktop Electron shell (menu, dialogs, updater, CLI installer). */

/**
 * Danish translation dictionary keyed by dotted message id; values may contain
...
export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af ClosedCode",
  ...
  "desktop.updater.downloaded.prompt": "Version {{version}} af ClosedCode er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message": "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'closedcode'-kommandoen.",
