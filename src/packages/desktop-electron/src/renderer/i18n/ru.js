/** @file Russian (ru) translation strings for desktop-specific renderer UI (menus, dialogs, updater, CLI install). */

/**
 * Russian translation table mapping desktop renderer message keys to their localized strings.
...
export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию ClosedCode",
  ...
  "desktop.updater.downloaded.prompt": "Версия ClosedCode {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message": "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'closedcode'.",
