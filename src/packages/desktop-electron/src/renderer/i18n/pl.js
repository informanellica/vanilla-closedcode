/** @file Polish (pl) translation strings for desktop-specific renderer UI (menus, dialogs, updater, CLI install). */

/**
 * Polish translation table mapping desktop renderer message keys to their localized strings.
...
export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji ClosedCode",
  ...
  "desktop.updater.downloaded.prompt": "Pobrano wersję {{version}} ClosedCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message": "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'closedcode'.",
