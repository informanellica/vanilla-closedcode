/** @file Arabic (ar) translation strings for the desktop Electron shell (menu, dialogs, updater, CLI installer). */

/**
 * Arabic translation dictionary keyed by dotted message id; values may contain
...
export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من ClosedCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من ClosedCode، هل ترغب في تثبيته وإعادة تشغيله؟",
