// ESM wrapper around fuzzysort 3.1.0 (CJS/UMD-only upstream).
//
// Upstream fuzzysort ships only a UMD build (node_modules/fuzzysort/fuzzysort.js)
// with `module.exports = UMD()`. Under native browser ESM there is no `module`
// global and top-level `this` is undefined, so the UMD bootstrap cannot run and
// the file is not importable directly.
//
// This wrapper inlines the upstream factory body verbatim (the `_ => { ... }`
// passed to the UMD IIFE) and exports its return value as the ESM default.
// Keep in sync with node_modules/fuzzysort/fuzzysort.js on upgrade.
//
// Source: https://github.com/farzher/fuzzysort v3.1.0
...
export const { single, go, prepare, cleanup } = fuzzysort
