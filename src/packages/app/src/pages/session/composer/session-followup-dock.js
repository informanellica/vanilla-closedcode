...
var _tmpl$ = /*#__PURE__*/_$template(`<span class="min-w-0 flex-1 truncate fw-normal text-body cursor-default">`),
  _tmpl$2 = /*#__PURE__*/_$template(`<div class="pl-3 pr-2 py-2 d-flex align-items-center gap-2"role=button tabindex=0><span class="shrink-0 fw-medium text-body-emphasis cursor-default"></span><div class="ml-auto shrink-0">`),
    ...
    get children() {
      return [(() => {
        ...
        _$insert(_el$4, _$createComponent(IconButton, {
          ...
          get ["aria-label"]() {
            return _$memo(() => !!store.collapsed)() ? language.t("session.followupDock.expand") : language.t("session.followupDock.collapse");
          }
        }));
        return _el$;
