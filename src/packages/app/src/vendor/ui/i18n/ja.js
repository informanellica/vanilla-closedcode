/** @file Japanese (ja) UI translation strings for the desktop renderer i18n layer. */

/**
 * Japanese translation dictionary mapping UI message keys to localized strings.
