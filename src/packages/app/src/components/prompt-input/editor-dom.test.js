...
import { createTextFragment, getCursorPosition, getNodeLength, getTextLength, setCursorPosition } from "./editor-dom.js";
describe("prompt-input editor dom", () => {
  test("createTextFragment preserves newlines with consecutive br nodes", () => {
    ...
    expect(container.childNodes[1].tagName).toBe("BR");
    expect(container.childNodes[2].tagName).toBe("BR");
