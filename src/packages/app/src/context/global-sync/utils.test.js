...
import { directoryKey, normalizeAgentList } from "./utils.js";
...
describe("normalizeAgentList", () => {
  ...
  test("drops invalid payloads", () => {
    ...
    expect(normalizeAgentList([{
      name: "build"
    }, agent("docs")])).toEqual([agent("docs")]);
  });
});
describe("directoryKey", () => {
  test("normalizes slashes", () => {
    expect(String(directoryKey("C:\\Repos\\sst\\closedcode"))).toBe("C:/Repos/sst/closedcode");
    expect(String(directoryKey("C:/Repos/sst/closedcode"))).toBe("C:/Repos/sst/closedcode");
  });
