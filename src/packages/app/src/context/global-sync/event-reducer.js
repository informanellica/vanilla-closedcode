    ...
    case "session.created":
      {
        ...
        input.setStore("session", reconcile(trimmed, {
          key: "id"
        }));
    ...
    case "session.updated":
      {
        ...
        if (info.time.archived) {
          if (result.found) {
            input.setStore("session", produce(draft => {
    ...
    case "session.diff":
      {
        ...
        input.setStore("session_diff", props.sessionID, reconcile(list(props.diff), {
          key: "file"
        }));
        break;
      }
    ...
    case "permission.asked":
      {
        ...
        input.setStore("permission", permission.sessionID, produce(draft => {
    ...
    case "permission.replied":
      {
        ...
        if (!result.found) break;
        input.setStore("permission", props.sessionID, produce(draft => {
          draft.splice(result.index, 1);
        }));
        break;
      }
    case "question.asked":
      {
        ...
        input.setStore("question", question.sessionID, produce(draft => {
    ...
    case "question.rejected":
      {
        ...
        if (!result.found) break;
        input.setStore("question", props.sessionID, produce(draft => {
          draft.splice(result.index, 1);
        }));
        break;
      }
