...
var _tmpl$ = /*#__PURE__*/_$template(`<div data-slot=list-item-add>`),
  _tmpl$2 = /*#__PURE__*/_$template(`<div data-slot=list-header class="text-uppercase small fw-semibold text-secondary px-3 pt-2 pb-1">`),
  _tmpl$3 = /*#__PURE__*/_$template(`<span>`),
  _tmpl$4 = /*#__PURE__*/_$template(`<span data-slot=list-filter class=fw-semibold>&quot;<!>&quot;`),
  _tmpl$5 = /*#__PURE__*/_$template(`<div data-slot=list-search-wrapper class="px-2 pt-2 pb-1"><div data-slot=list-search class="input-group input-group-sm"><div data-slot=list-search-container class="d-flex align-items-center gap-1 flex-grow-1">`),
  _tmpl$6 = /*#__PURE__*/_$template(`<div data-slot=list-group><div data-slot=list-items class="list-group list-group-flush">`),
  _tmpl$7 = /*#__PURE__*/_$template(`<div data-component=list class="d-flex flex-column h-100 overflow-hidden"><div data-slot=list-scroll class="flex-grow-1 overflow-auto">`),
  _tmpl$8 = /*#__PURE__*/_$template(`<div data-slot=list-empty-state class="text-center text-secondary small py-4"><div data-slot=list-message>`),
  _tmpl$9 = /*#__PURE__*/_$template(`<span data-slot=list-item-selected-icon class="ms-auto text-primary">`),
  _tmpl$0 = /*#__PURE__*/_$template(`<button data-slot=list-item type=button class="list-group-item list-group-item-action d-flex align-items-center gap-2 text-start border-0">`),
  _tmpl$1 = /*#__PURE__*/_$template(`<span data-slot=list-item-active-icon class="ms-auto text-secondary">`),
  _tmpl$10 = /*#__PURE__*/_$template(`<span data-slot=list-item-divider class="border-bottom d-block">`);
...
// Self-contained port of ui useFilteredList (pure solid-js, no UI deps).
...
export function List(props) {
  ...
  const emptyMessage = () => {
    if (grouped.loading) return props.loadingMessage ?? FALLBACK_MESSAGES.loading;
    if (props.emptyMessage) return props.emptyMessage;
    const query = filter();
    if (!query) return FALLBACK_MESSAGES.empty;
    const suffix = FALLBACK_MESSAGES.emptySuffix;
    return [(() => {
      var _el$3 = _tmpl$3();
      _$insert(_el$3, FALLBACK_MESSAGES.emptyPrefix);
      return _el$3;
    })(), (() => {
      var _el$4 = _tmpl$4(),
                ...
                children: (item, i) => {
                  const node = (() => {
                    ...
                    _$effect(_p$ => {
                      ...
                      _v$2 !== _p$.t2 && _el$18.classList.toggle("active", _v$2);
                      _p$.t2 = _v$2;
