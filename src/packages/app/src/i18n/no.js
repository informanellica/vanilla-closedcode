/** @file Norwegian (no) translation dictionary for the desktop app renderer UI. */

/**
 * Norwegian translation table mapping i18n keys to their localized strings.
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av ClosedCode",
  ...
  "provider.connect.apiKey.description": "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i ClosedCode.",
  ...
  "provider.connect.oauth.code.visit.suffix": " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i ClosedCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i ClosedCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i closedcode.json",
  ...
  "dialog.server.description": "Bytt hvilken ClosedCode-server denne appen kobler til.",
  ...
  "dialog.project.edit.worktree.startup.placeholder": "f.eks. npm install",
  ...
  "toast.update.description": "En ny versjon av ClosedCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til ClosedCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (closedcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at ClosedCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "ClosedCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør ClosedCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for ClosedCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan ClosedCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om ClosedCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan ClosedCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når ClosedCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av ClosedCode.",
