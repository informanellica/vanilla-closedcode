export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ClosedCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description": "{{provider}} hesabınızı bağlamak ve ClosedCode'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix": "Hesabınızı bağlamak ve ClosedCode'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix": " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak ClosedCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler closedcode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi ClosedCode sunucusuna bağlanacağını değiştirin.",
  ...
  "dialog.project.edit.worktree.startup.placeholder": "örneğin npm install",
  ...
  "toast.update.description": "ClosedCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı ClosedCode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (closedcode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed": 'MCP sunucusu "{{name}}" başarısız oldu. Not: ClosedCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "ClosedCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "ClosedCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "ClosedCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "ClosedCode'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "ClosedCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description": "ClosedCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "ClosedCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "ClosedCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "ClosedCode'un en son sürümünü kullanıyorsunuz.",
