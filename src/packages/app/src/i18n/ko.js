...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ClosedCode에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description": "{{provider}} API 키를 입력하여 계정을 연결하고 ClosedCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix": "를 방문하여 인증 코드를 받아 계정을 연결하고 ClosedCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix": "를 방문하고 아래 코드를 입력하여 계정을 연결하고 ClosedCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "closedcode.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 ClosedCode 서버를 전환합니다.",
  ...
  "dialog.project.edit.worktree.startup.placeholder": "예: npm install",
  ...
  "toast.update.description": "ClosedCode의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 ClosedCode 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(closedcode.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: ClosedCode는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "ClosedCode에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 ClosedCode 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "ClosedCode 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 ClosedCode가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "ClosedCode가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "ClosedCode 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "ClosedCode를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 ClosedCode를 사용 중입니다.",
