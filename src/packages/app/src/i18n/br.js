/** @file Brazilian Portuguese (br) translation dictionary: maps i18n message keys to their localized strings; {{placeholders}} are runtime interpolation tokens. */
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo ClosedCode",
  ...
  "provider.connect.apiKey.description": "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no ClosedCode.",
  ...
  "provider.connect.oauth.code.visit.suffix": " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no ClosedCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no ClosedCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em closedcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor ClosedCode este aplicativo se conecta.",
  ...
  "dialog.project.edit.worktree.startup.placeholder": "ex: npm install",
  ...
  "toast.update.description": "Uma nova versão do ClosedCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do ClosedCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (closedcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: ClosedCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "ClosedCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor ClosedCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do ClosedCode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o ClosedCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o ClosedCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o ClosedCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o ClosedCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do ClosedCode.",
