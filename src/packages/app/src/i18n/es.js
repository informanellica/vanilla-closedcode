/** @file Spanish (es) translation dictionary: maps i18n message keys to their localized strings; {{placeholders}} are runtime interpolation tokens. */
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por ClosedCode",
  ...
  "provider.connect.apiKey.description": "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en ClosedCode.",
  ...
  "provider.connect.oauth.code.visit.suffix": " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en ClosedCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en ClosedCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados en closedcode.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de ClosedCode se conecta esta app.",
  ...
  "dialog.project.edit.worktree.startup.placeholder": "p. ej. npm install",
  ...
  "toast.update.description": "Una nueva versión de ClosedCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de ClosedCode",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (closedcode.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, ClosedCode no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "ClosedCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor ClosedCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para ClosedCode",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve ClosedCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si ClosedCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de ClosedCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia ClosedCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de ClosedCode.",
