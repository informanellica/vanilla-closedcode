export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje ClosedCode",
  ...
  "provider.connect.apiKey.description": "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u ClosedCode-u.",
  ...
  "provider.connect.oauth.code.visit.suffix": " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u ClosedCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u ClosedCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u closedcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se ClosedCode server ova aplikacija povezuje.",
  ...
  "dialog.project.edit.worktree.startup.placeholder": "npr. npm install",
  ...
  "toast.update.description": "Nova verzija ClosedCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku ClosedCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (closedcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: ClosedCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "ClosedCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni ClosedCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u ClosedCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako ClosedCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li ClosedCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu ClosedCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se ClosedCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju ClosedCode-a.",
