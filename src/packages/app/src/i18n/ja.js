...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ClosedCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description": "{{provider}}のAPIキーを入力してアカウントを接続し、ClosedCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix": " にアクセスして認証コードを取得し、アカウントを接続してClosedCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " にアクセスし、以下のコードを入力してアカウントを接続し、ClosedCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.custom.models.discover.button": "APIから取得",
  "provider.custom.models.discover.loading": "取得中...",
  "provider.custom.models.discover.success.title": "モデルを取得しました",
  "provider.custom.models.discover.success.description": "{{count}} 個のモデルを取得しました",
  "provider.custom.models.discover.error": "モデルの取得に失敗しました",
  ...
  "dialog.plugins.empty": "closedcode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するClosedCodeサーバーを切り替えます。",
  ...
  "dialog.project.edit.worktree.startup.placeholder": "例: npm install",
  ...
  "toast.update.description": "ClosedCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーを報告してください: ",
  "error.page.report.discord": "Discord",
  "error.page.report.github": "GitHub",
  "error.page.report.separator": "または",
  ...
  "error.chain.checkConfig": "config (closedcode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ClosedCodeはまだMCP認証をサポートしていません。',
  ...
  "home.hero.intro": "ローカル LLM で動く AI コーディングワークスペース。フォルダを開いて始めましょう。",
  "home.hero.cta": "フォルダを開く",
  "home.recentProjects": "最近のプロジェクト",
  "home.empty.title": "最近のプロジェクトはありません",
  "home.empty.description": "ローカルプロジェクトを開いて始めましょう",
  "home.section.start": "スタート",
  "home.section.configuration": "構成",
  "home.section.server": "サーバー",
  "home.server.online": "オンライン",
  "home.server.offline": "オフライン",
  "home.server.connecting": "接続中…",
  "home.server.manage": "管理",
  ...
  "sidebar.gettingStarted.line1": "ClosedCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でClosedCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "ClosedCodeの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのClosedCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "ClosedCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "ClosedCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "ClosedCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "ClosedCode は最新バージョンです。",
