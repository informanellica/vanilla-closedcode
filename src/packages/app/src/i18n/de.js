export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von ClosedCode",
  ...
  "provider.connect.apiKey.description": "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ClosedCode zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix": ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in ClosedCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in ClosedCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In closedcode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den ClosedCode-Server, mit dem sich diese App verbindet.",
  ...
  "dialog.project.edit.worktree.startup.placeholder": "z. B. npm install",
  ...
  "toast.update.description": "Eine neue Version von ClosedCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem ClosedCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (closedcode.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed": 'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: ClosedCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "ClosedCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "ClosedCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für ClosedCode ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie ClosedCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob ClosedCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von ClosedCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von ClosedCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von ClosedCode.",
