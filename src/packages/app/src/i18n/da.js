/** @file Danish (da) translation dictionary: maps i18n message keys to their localized strings; {{placeholders}} are runtime interpolation tokens. */
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af ClosedCode",
  ...
  "provider.connect.apiKey.description": "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i ClosedCode.",
  ...
  "provider.connect.oauth.code.visit.suffix": " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i ClosedCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i ClosedCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i closedcode.json",
  ...
  "dialog.server.description": "Skift hvilken ClosedCode-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af ClosedCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til ClosedCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (closedcode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, ClosedCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "ClosedCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør ClosedCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for ClosedCode",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan ClosedCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om ClosedCode følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan ClosedCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når ClosedCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af ClosedCode.",
